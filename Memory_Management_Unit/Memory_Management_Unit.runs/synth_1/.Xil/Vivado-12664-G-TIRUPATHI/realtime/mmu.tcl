...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-12664-G-TIRUPATHI/realtime/tmp"
    ...
    set rt::SDCFileList ./.Xil/Vivado-12664-G-TIRUPATHI/realtime/mmu_synth.xdc
    rt::sdcChecksum
    set rt::top mmu
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-12664-G-TIRUPATHI/"
    if {$rt::useElabCache == false} {
